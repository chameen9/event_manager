                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-2">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" name="email" class="form-control" placeholder="example@example.com" value="{{ old('email', $student->email) }}" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-2">
                                                    <div class="mb-3">
                                                        <label class="text-label form-label">Phone Number<span class="required">*</span></label>
                                                        <input type="text" maxlength="10" name="phone" class="form-control" placeholder="07XXXXXXXX" value="{{ old('phone', $student->phone) }}" required>
                                                    </div>
                                                </div>
    ...
    <script>
        (function () {
            ...
            function formatLKR(amount) {
                return 'LKR. ' + amount.toLocaleString('en-LK') + '.00';
            }
            ...
            function calculateTotals() {
                ...
                const photoTotal = photoCount * PHOTO_PRICE;
                ...
                // Update individual totals (optional safety)
                ...
                // Final total
                const finalAmount = photoTotal + seatTotal + shuttleTotal + PACKAGE_PRICE;

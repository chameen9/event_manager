                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="student_id" type="hidden" value="{{ $studentData['student']->student_id }}">
                                    <input name="id" type="hidden" value="{{ $studentData['student']->id }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <a type="button" href="{{route('admin.students.index')}}" class="btn btn-light">Cancel</a>
                            </div>              
                        </div>
                    </div>
                </form>
                                    ...
                                    <tbody>
                                        @foreach ($program['modules'] as $module)
                                            <tr>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ route('admin.modules.toggle') }}"
                                                        method="POST"
                                                        class="d-inline"
                                                    >
                                                        @csrf
                                                        ...
                                                        <button
                                                            type="submit"
                                                            class="btn btn-sm
                                                                {{ $module['completed'] ? 'light btn-danger' : 'light btn-success' }}"
                                                        >
                                                            {{ $module['completed'] ? 'Mark Pending' : 'Mark Complete' }}
                                                        </button>
                                                    </form>
                                                </td>
                                            </tr>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button 
                            class="btn light btn-primary"
                            data-bs-toggle="modal"
                            data-bs-target="#addEventLogModal"
                        >
...
@include('admin.partials.modal-eventlog')